...
public class HomeWork extends BaseActivity {
   ...
   ,"作业51：震动","作业52：闹钟"
    ,"作业53:MediaPlayer和SurfaceView播放视频","作业54：Retrofit股票查询","作业55：上传数据到服务器","作业56：指南针","作业57：摇一摇"};
    Class [] classzz={MainActivity.class,A0_02Activity.class,A0_04Activiy.class,heart.class,text1.class,qq.class,Biaoge.class,wuse.class,xiangdui.class,A0_pic.class
            ...
            ,A0_zhendong.class,A0_naozhong.class
            ,A0_51zuoye.class,A0_52zuoye.class,A0_53zuoye.class,A0_55zuoye.class,A0_56zuoye1.class};
