 ...
 */
public class A0_51zuoye extends BaseActivity implements View.OnClickListener{
    SurfaceView sv;
    Button play;
    Button pause;
    Button stop;
    ...
    protected void initContentView(Bundle savedInstanceState) {
        setContentView(R.layout.a0_51zuoye);
    ...
    public void play() throws IOException {
        ...
        player.setDataSource("/mnt/sdcard/myvideo.mp4");
